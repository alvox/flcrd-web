...
func (app *application) accessTokenInvalid(w http.ResponseWriter) {
	handleError(w, http.StatusUnauthorized, &ApiError{
		Code:    "002",
...
func (app *application) badRequest(w http.ResponseWriter) {
	handleError(w, http.StatusBadRequest, &ApiError{
		Code:    "004",
...
func (app *application) notFound(w http.ResponseWriter, model string) {
	handleError(w, http.StatusNotFound, &ApiError{
		Code:    "009",
...
func handleError(w http.ResponseWriter, status int, e *ApiError) {
